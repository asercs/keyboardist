...
const ProductPageDynamic = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/getKeyboard/${order}`)
          .then((res) => res.json())
            ...
            <div className="text-white">
                <div className="flex md:flex-row flex-col sm:py-16 py-6 mx-auto mt-10 gap-4">
                    ...
                    <div className="flex flex-1 flex-col font-bold">
                        ...
                        <h2 className="text-xl my-4">{product?.quantity} in stock</h2>
                        ...
                        <button className="text-xl font-bold p-2 rounded-xl bg-yellow-400 flex justify-center items-center my-4">
                            Buy with
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6" version="1.1" id="Layer_1" x="0px" y="0px" width="124px" height="33px" viewBox="0 0 124 33" enableBackground="new 0 0 124 33">
