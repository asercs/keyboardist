            ...
            <form className="space-y-4 md:space-y-6" onSubmit={submit}>
              ...
              <div>
                ...
                <input
                  ...
                  id="password"
                  placeholder="••••••••"
                  className="border sm:text-sm rounded-lg focus:border-cyan-600 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                  required
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="terms" className="font-light text-gray-300">
                    I accept the{' '}
                    <Link className="font-medium hover:underline text-cyan-500" to="terms">
              ...
              <p className="text-sm font-light text-gray-400">
                ...
                <Link to="/signin" className="font-medium text-cyan-500 hover:underline">
                  Login here
                </Link>
              </p>
            </form>
